        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                {paymentInfo.payment_type && (
                  <div>
                    ...
                    <dd className="mt-1 text-sm text-gray-900 uppercase">
                      {paymentInfo.payment_type === "ticket"
                        ? "Boleto"
              ...
              {paymentInfo.payment_type === "ticket" ? (
                <>
                  <li className="flex items-start">
                    ...
                    <span>
                      O boleto foi enviado para seu e-mail. Você tem até 3 dias úteis
                ...
                <>
                  <li className="flex items-start">
                    <Package className="h-5 w-5 mr-2 flex-shrink-0 mt-0.5" />
                    <span>
                      Seu pagamento está sendo processado. A confirmação pode levar
                      alguns minutos.
                    </span>
                  </li>
                  <li className="flex items-start">
          ...
          <div className="bg-yellow-50 rounded-lg p-4 mb-6">
            <p className="text-sm text-yellow-800">
              <strong>Importante:</strong> Seu pedido só será processado após a
              confirmação do pagamento. Mantenha seu e-mail e telefone atualizados para
